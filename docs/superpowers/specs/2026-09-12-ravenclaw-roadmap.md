...
Job-host state (**implemented**): **`2026-09-17-job-host-state-roadmap.md`**. Rewind persist-before-reset (**implemented** at `048deff`): **`2026-09-18-rewind-persist-and-todo-projection.md`**. Cancel abort-pair / reset-on-resume / follow-up persist (**implemented** at `5eefdde`): **`2026-09-18-cancel-reset-followup.md`**. Previous (implemented): `2026-09-16-session-as-job-roadmap.md`, `2026-09-15-eve-inspired-roadmap.md`.  
