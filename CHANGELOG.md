...
### Added
- Architecture and slash-command references: [ARCHITECTURE.md](ARCHITECTURE.md) / [ARCHITECTURE.ko.md](ARCHITECTURE.ko.md), [SLASH_COMMANDS.md](SLASH_COMMANDS.md) / [SLASH_COMMANDS.ko.md](SLASH_COMMANDS.ko.md). Docs match the shipped waist: schema version **6**, `pending_asks`, `applyAskAnswer`, and `POST /v1/session/:id/{stream,submit,resolve,cancel,compact}`.
...
- Prior-art note for y0 (hosted Task-as-job shell) and the next-horizon roadmap that steals shadow-branch delivery, turn-end commit, checkpoints, and a reconnectable serve waist — not Prisma/Socket.IO/Next: [docs/research/y0-analysis.md](docs/research/y0-analysis.md) ([한국어](docs/research/y0-analysis.ko.md)), [docs/superpowers/specs/2026-09-16-session-as-job-roadmap.md](docs/superpowers/specs/2026-09-16-session-as-job-roadmap.md).
- Implementation plan for the session-as-job horizon (15 TDD tasks, Waves F0–F4): [docs/superpowers/plans/2026-09-16-session-as-job-implementation.md](docs/superpowers/plans/2026-09-16-session-as-job-implementation.md).
