...
Next horizon (this branch): [`2026-09-18-no-job-todo-revert.md`](2026-09-18-no-job-todo-revert.md) (amends this spec’s OUT for no-job todo revert only). Parent-cancels-child-ask is amended by [`2026-09-18-parent-tree-stop.md`](2026-09-18-parent-tree-stop.md) (tree-stop, not leftover-only).
