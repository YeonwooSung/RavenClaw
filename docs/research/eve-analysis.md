...
RavenClaw leftover-ask now has an `'ignored'` operator result ([`2026-09-21-ignored-dismiss.md`](../superpowers/specs/2026-09-21-ignored-dismiss.md)). Dismiss-on-message still parked.
