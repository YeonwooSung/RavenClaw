...
| `y` / `n` / `a` / `i` / `skip` / `ignored` 한 줄 | OpenTUI permission | 그 외는 deny. Slack Skip / Discord skip 텍스트 / ACP Skip → `'ignored'`. 스펙: [`2026-09-22-hitl-skip-hosts.md`](docs/superpowers/specs/2026-09-22-hitl-skip-hosts.md) |
