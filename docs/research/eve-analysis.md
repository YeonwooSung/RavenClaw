...
That eve-inspired horizon is implemented. Session-as-job is implemented (`docs/superpowers/specs/2026-09-16-session-as-job-roadmap.md`). Next: `docs/superpowers/specs/2026-09-17-job-host-state-roadmap.md`.
