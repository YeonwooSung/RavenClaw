...
Session-as-job horizon (**implemented** on `main` at `ea56edd`, closeout `0ef1554`): **`2026-09-16-session-as-job-roadmap.md`**. Job-host state (**implemented** on `main` at `6e56764`): **`2026-09-17-job-host-state-roadmap.md`**. Rewind persist-before-reset / `todo.json` projection (**implemented** on `main` at `048deff`): **`2026-09-18-rewind-persist-and-todo-projection.md`**. Cancel abort-pair / reset-on-resume / follow-up persist (**implemented** on `main` at `5eefdde`): **`2026-09-18-cancel-reset-followup.md`**. No-job todo revert (**implemented** on `main` at `be5a4a7`): **`2026-09-18-no-job-todo-revert.md`**. Stream version / `continuationToken` (**implemented** on `main` at `c9c4871`): **`2026-09-18-stream-version-token.md`**. Keep-id `/clear` (**implemented** on `main` at `edeb611`): **`2026-09-18-keep-id-clear.md`**. Parent tree-stop (**implemented** on `main` at `9901d0e`): **`2026-09-18-parent-tree-stop.md`**. Leftover-ask abort-pair completeness + cancel 202/200 (**implemented** on `main` at `067bfba`): **`2026-09-20-leftover-ask-abort-pair.md`**. HTTP `POST …/clear` (**implemented** on `main` at `a53be93`): **`2026-09-20-http-post-clear.md`**. Rewind recovery / schema v11 / async `createSessionEngine` (**implemented** on `main` at `dc45aec`): **`2026-09-20-rewind-recovery-v11.md`**. Grep/Glob docker-exec (**implemented** on `main` at `a52eab1`): **`2026-09-21-grep-glob-docker-exec.md`**. Ignored dismiss-and-continue (**implemented** on `main` at `22a55c1`): **`2026-09-21-ignored-dismiss.md`**. Bounded LSP depth (**implemented** on `main` at `6c797d1`): **`2026-09-21-lsp-depth.md`**. Instruction files `/config` (**implemented** on `main` at `0a1176f`): **`2026-09-21-instruction-files-config.md`**. WorkspaceFs docker I/O (**implemented** on `main` at `9c8d9db`): **`2026-09-21-workspacefs-docker.md`**. NotebookEdit docker (**implemented** on `main` at `6d439b6`): **`2026-09-21-notebookedit-docker.md`**. Dismiss-on-message (**implemented** on `main` at `061d23c`): **`2026-09-21-dismiss-on-message.md`**. jobDiff `runGit` env isolation (**implemented** on `main` at `2c2f009`): **`2026-09-20-jobdiff-parallel-flake.md`**. Previous (implemented): `2026-09-15-eve-inspired-roadmap.md`. Prior-art: [eve-analysis.md](../../research/eve-analysis.md), [y0-analysis.md](../../research/y0-analysis.md).
...
- Streaming tool executor, background skill curator, real LSP handshake (museum; bounded six-op depth shipped in `2026-09-21-lsp-depth.md` at `6c797d1`)
- Pro = no ads
...
`execute_code`, Electron, streaming executor, curator, real LSP handshake (museum). Slack/Discord + pairing + ledger already shipped. Eve-style durable HITL is implemented (`2026-09-15-eve-inspired-roadmap.md`). Session-as-job F3 (reconnect + cancel) is implemented. Job-host state is implemented (`2026-09-17-job-host-state-roadmap.md` at `6e56764`). Rewind persist-before-reset is implemented (`2026-09-18-rewind-persist-and-todo-projection.md` at `048deff`). Cancel abort-pair / reset-on-resume / follow-up persist is implemented (`2026-09-18-cancel-reset-followup.md` at `5eefdde`). No-job todo revert is implemented (`2026-09-18-no-job-todo-revert.md` at `be5a4a7`). Stream `version` / `continuationToken` is amended by `2026-09-18-stream-version-token.md`. Rewind recovery / schema v11 / async `createSessionEngine` is amended by `2026-09-20-rewind-recovery-v11.md`. Grep/Glob docker-exec is implemented (`2026-09-21-grep-glob-docker-exec.md` at `a52eab1`). Ignored leftover-ask / live `askUser` result is implemented (`2026-09-21-ignored-dismiss.md` at `22a55c1`). Dismiss-on-message is implemented (`2026-09-21-dismiss-on-message.md` at `061d23c`). Bounded LSP depth is implemented (`2026-09-21-lsp-depth.md` at `6c797d1`). Instruction files `/config` is implemented (`2026-09-21-instruction-files-config.md` at `0a1176f`). WorkspaceFs docker I/O is implemented (`2026-09-21-workspacefs-docker.md` at `9c8d9db`). NotebookEdit docker is implemented (`2026-09-21-notebookedit-docker.md` at `6d439b6`). jobDiff `runGit` env isolation is implemented (`2026-09-20-jobdiff-parallel-flake.md` at `2c2f009`). If a later product wants a browser, it still implements G0–G3 on the existing F3 stream. Do not extend this file.
