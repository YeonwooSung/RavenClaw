...
세션-을-잡 로드맵 (구현됨): `docs/superpowers/specs/2026-09-16-session-as-job-roadmap.md`. Job-host state (구현됨, `6e56764`): `docs/superpowers/specs/2026-09-17-job-host-state-roadmap.md`. Rewind persist-before-reset (구현됨, `048deff`): `docs/superpowers/specs/2026-09-18-rewind-persist-and-todo-projection.md`. Cancel abort-pair / reset-on-resume / follow-up persist (구현됨, `5eefdde`): `docs/superpowers/specs/2026-09-18-cancel-reset-followup.md`. No-job todo revert (구현됨, `be5a4a7`): `docs/superpowers/specs/2026-09-18-no-job-todo-revert.md`. Stream version / `continuationToken` (구현됨, `c9c4871`): `docs/superpowers/specs/2026-09-18-stream-version-token.md`. Keep-id `/clear` (구현됨, `edeb611`): `docs/superpowers/specs/2026-09-18-keep-id-clear.md`. Parent tree-stop (구현됨, `9901d0e`): `docs/superpowers/specs/2026-09-18-parent-tree-stop.md`. Leftover-ask abort-pair completeness + cancel 202/200 (구현됨): `docs/superpowers/specs/2026-09-20-leftover-ask-abort-pair.md`.
