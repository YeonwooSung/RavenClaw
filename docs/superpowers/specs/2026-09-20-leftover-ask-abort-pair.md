...
- wiki / isolation-trust / Workflow loop / agent compiler / `ignored` (leftover-ask / live `askUser` result amended by `2026-09-21-ignored-dismiss.md`; dismiss-on-message amended by `2026-09-21-dismiss-on-message.md`) / Grep/Glob docker-exec
...
`ignored` as a leftover-ask / live `askUser` result is amended by `2026-09-21-ignored-dismiss.md`. dismiss-on-message amended by `2026-09-21-dismiss-on-message.md`.
