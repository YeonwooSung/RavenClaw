...
**Shipped pointer (2026-09-21).** Grep/Glob docker-exec landed on `main` at `a52eab1` ([`2026-09-21-grep-glob-docker-exec.md`](2026-09-21-grep-glob-docker-exec.md)): search shares Bash’s `TerminalBackend` (one `docker run` per call). WorkspaceFs docker-exec (Read/Write/Edit/ApplyPatch/ListDir/ReadSubtree `docker exec cat`) is still parked. `ignored` leftover-ask result landed at `22a55c1` ([`2026-09-21-ignored-dismiss.md`](2026-09-21-ignored-dismiss.md); dismiss-on-message amended by [`2026-09-21-dismiss-on-message.md`](2026-09-21-dismiss-on-message.md)). Bounded LSP depth landed at `6c797d1` ([`2026-09-21-lsp-depth.md`](2026-09-21-lsp-depth.md); handshake museum stays OUT). NotebookEdit docker and web UI stay OUT.
