...
Next horizon (implemented at `6e56764`): [`2026-09-17-job-host-state-roadmap.md`](2026-09-17-job-host-state-roadmap.md). After that: [`2026-09-18-rewind-persist-and-todo-projection.md`](2026-09-18-rewind-persist-and-todo-projection.md).
