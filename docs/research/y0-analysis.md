...
Session-as-job roadmap (implemented): `docs/superpowers/specs/2026-09-16-session-as-job-roadmap.md`. Job-host state (implemented at `6e56764`): `docs/superpowers/specs/2026-09-17-job-host-state-roadmap.md`. Next: `docs/superpowers/specs/2026-09-18-rewind-persist-and-todo-projection.md`.
