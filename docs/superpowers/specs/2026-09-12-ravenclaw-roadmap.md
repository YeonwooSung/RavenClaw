...
Job-host state (**implemented**): **`2026-09-17-job-host-state-roadmap.md`**. Parked next (no spec yet): rewind persist-before-reset / `todo.json` re-project. Previous (implemented): `2026-09-16-session-as-job-roadmap.md`, `2026-09-15-eve-inspired-roadmap.md`.  
