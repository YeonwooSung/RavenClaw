...
Next horizon (implemented at `6e56764`): [`2026-09-17-job-host-state-roadmap.md`](2026-09-17-job-host-state-roadmap.md). After that (implemented at `048deff`): [`2026-09-18-rewind-persist-and-todo-projection.md`](2026-09-18-rewind-persist-and-todo-projection.md).
...
- live `/cancel` abort-pair of a parked leftover-ask (still: cancel a live turn; parked rows stay; stream must say so)
