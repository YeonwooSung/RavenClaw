...
세션-을-잡 로드맵 (구현됨): `docs/superpowers/specs/2026-09-16-session-as-job-roadmap.md`. Job-host state (구현됨, `6e56764`): `docs/superpowers/specs/2026-09-17-job-host-state-roadmap.md`. Rewind persist-before-reset (구현됨, `048deff`): `docs/superpowers/specs/2026-09-18-rewind-persist-and-todo-projection.md`.
